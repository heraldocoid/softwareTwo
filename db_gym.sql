...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2016 a las 02:08:42
...
INSERT INTO `accesos` (`identificacion`, `usuario`, `contrasena`, `tipo_usuario`) VALUES
(4292471, 'hugo', 'hugo', 'Usuario'),
(52305443, 'Sandra', '12345', 'Usuario'),
...
(4292471, 'Hugo', ' ', 'Hugo', 'Martinez', '52', 'Masculino', 1.5, 70, 'Bajar de peso', 3, 31.1111, 'no hay observaciones'),
(52305443, 'Sandara', 'Patricia', 'Sandara', 'Espinosa', '40', 'Masculino', 1.7, 60, 'Marcar', 2, 20.7612, 'sufre de asma'),
...
(1013607937, 'Yulieth', 'Andrea', 'Yulieth', 'Galeano', '26', 'Masculino', 1.5, 55, 'Bajar de peso', 2, 24.4444, 'no hay'),
